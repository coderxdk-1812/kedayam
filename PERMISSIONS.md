...
| `webNavigation`  | Detect navigation start, redirects, and commit to evaluate the destination *before* page load completes. | Content scripts run too late to warn pre-render. |
