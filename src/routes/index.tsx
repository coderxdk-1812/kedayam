  ...
  const features = [
    {
      ...
      copy: "Scores risky pages before credentials or personal data are exposed.",
    },
    {
      icon: KeyRound,
      title: "Sensitive data detection",
      copy: "Finds PII, payment cards, API tokens, JWTs, and private keys locally.",
    },
    {
      icon: UploadCloud,
      title: "Upload scanning",
      copy: "Reviews text-based files before they leave the browser.",
    },
    {
      icon: Lock,
    ...
    {
      icon: EyeOff,
      title: "Clone website detection",
      copy: "Flags lookalike domains, homoglyph tricks, and suspicious URL shapes.",
    },
    {
      icon: Radar,
      title: "Real-time trust scoring",
      copy: "Shows an explainable 0–100 verdict from local and reputation signals.",
    },
  ];
  ...
  const flow = [
    {
      icon: MousePointer2,
      title: "User browses",
      copy: "Kedayam quietly observes page navigations and sensitive actions.",
    },
    {
      icon: ScanLine,
      title: "Scans locally",
      copy: "Pastes, uploads, URL shape, and browser signals are analyzed on-device.",
    },
    {
      icon: Radar,
      title: "Threats analyzed",
      copy: "Reputation APIs are only used for domain intelligence when configured.",
    },
    {
      icon: ShieldCheck,
      title: "Warns before danger",
      copy: "Low risk stays passive. Medium is concise. High risk requires intent.",
    },
  ];
  ...
  const installSteps = [
    {
      ...
      copy: "Save kedayam.zip, then unzip it into a folder you can find again.",
    },
    {
      icon: Chrome,
      title: "Open extensions",
      copy: "Go to chrome://extensions in Chrome, Edge, Brave, Arc, or Opera.",
    },
    {
      icon: Settings,
      title: "Enable Developer Mode",
      copy: "Turn on the Developer mode toggle in the top-right corner.",
    },
    {
      icon: UploadCloud,
      title: "Load Unpacked",
      copy: "Click Load unpacked from the toolbar at the top of the page.",
    },
    {
      icon: FolderOpen,
      title: "Select build folder",
      copy: "Choose the unzipped Kedayam folder that contains manifest.json.",
    },
    {
      icon: CheckCircle2,
      title: "Kedayam activates",
      copy: "Pin the shield to your toolbar and open any site to see a trust score.",
    },
  ];
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      <section className="relative min-h-[92vh] px-6 py-6 md:px-10">
        ...
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-[linear-gradient(to_right,color-mix(in_oklab,var(--border)_42%,transparent)_1px,transparent_1px),linear-gradient(to_bottom,color-mix(in_oklab,var(--border)_42%,transparent)_1px,transparent_1px)] bg-[size:72px_72px] opacity-20"
        />

        <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between py-2">
          <a
            href="#top"
            className="flex items-center gap-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background"
          >
        ...
        <div
          id="top"
          className="relative z-10 mx-auto grid max-w-7xl gap-14 pb-16 pt-20 md:pt-28 lg:grid-cols-[1.02fr_0.98fr] lg:items-center"
        >
          <motion.div {...fadeUp}>
          ...
          <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.08 }} className="relative">
            <div className="rounded-3xl border border-border bg-surface p-5 shadow-2xl shadow-background/60 backdrop-blur-2xl md:p-7">
              <div className="flex items-center justify-between gap-4 border-b border-border pb-5">
                ...
                <span className="rounded-full border border-border bg-background/50 px-3 py-1 text-xs font-medium text-safe">
                  Protected
                </span>
              </div>
              ...
              <div className="grid gap-7 py-8 sm:grid-cols-[180px_1fr] sm:items-center">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={signal}
                      className="flex items-center gap-3 rounded-2xl border border-border bg-background/35 px-4 py-3 text-sm"
                    >
      ...
      <section className="px-6 py-20 md:px-10" aria-labelledby="features-title">
        <div className="mx-auto max-w-7xl">
          <motion.div {...fadeUp} className="max-w-2xl">
            <p className="text-sm font-semibold uppercase tracking-[0.22em] text-cyber">
              Capabilities
            </p>
            <h2
              id="features-title"
              className="mt-3 text-3xl font-semibold tracking-normal md:text-5xl"
            >
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              ...
              >
                <feature.icon
                  className="h-6 w-6 text-cyber transition group-hover:scale-105"
                  aria-hidden="true"
                />
      ...
      <section
        className="border-y border-border bg-surface/40 px-6 py-20 md:px-10"
          ...
          >
            <div>
              ...
              <h2
                ...
                className="mt-3 text-3xl font-semibold tracking-normal md:text-5xl"
              >
                Private by default. Clear when it matters.
              </h2>
              <p className="mt-5 text-base leading-8 text-muted-foreground">
                Kedayam prioritizes local scanning, quiet context, and proportionate warnings
          ...
          >
            <div className="max-w-2xl">
              ...
              <h2
                ...
                className="mt-3 text-3xl font-semibold tracking-normal md:text-5xl"
              >
                Install in a few deliberate steps.
              </h2>
            </div>
            <button
              onClick={download}
          ...
          <div className="mt-12 grid gap-4 lg:grid-cols-3">
            {installSteps.map((step, index) => (
              <motion.article
                key={step.title}
                {...fadeUp}
                className="rounded-2xl border border-border bg-surface p-5 backdrop-blur-xl"
              >
        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.75fr_1.25fr]">
          <motion.div {...fadeUp}>
            ...
            <h2
              ...
              className="mt-3 text-3xl font-semibold tracking-normal md:text-5xl"
            >
              Clean reloads, clear fixes.
            </h2>
            <p className="mt-5 text-base leading-8 text-muted-foreground">
              The install package validates manifest paths, PNG icons, popup files, options files,
              content scripts, and service worker references before it ships.
            </p>
          </motion.div>
          <motion.div {...fadeUp} className="space-y-3">
            {troubleshooting.map((item) => (
              <details
                key={item.issue}
                className="group rounded-2xl border border-border bg-surface p-5 backdrop-blur-xl"
              >
      ...
      >
        <motion.div
          {...fadeUp}
          className="mx-auto max-w-7xl rounded-3xl border border-border bg-background/45 p-7 backdrop-blur-xl md:p-10"
        >
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            <div>
              ...
              <h2
                id="privacy-title"
                className="mt-5 text-3xl font-semibold tracking-normal md:text-5xl"
              >
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div
                  key={item}
                  className="flex gap-3 rounded-2xl border border-border bg-surface p-4 text-sm"
                >
