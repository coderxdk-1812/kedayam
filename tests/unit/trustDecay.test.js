...
describe("trustDecay", () => {
  ...
  it("decays mildly for hidden overlay / CSP / redirect storm / mfa split", () => {
    const r = trustDecay({ trustedRoot: true,
      hiddenLoginOverlay: true, cspWeakened: true,
      authFlow: { anomalies: [{ id: "redirect-storm" },
        { id: "mfa-origin-split" }] } });
